 ...
 *
 * English-only for now, unlike the Dashboard's EN/KO toggle — not
 * asked for here, and this page's whole premise (read in under 10
 * seconds) argues against adding a second control to it. Revisit if
 * the toggle's scope ever expands past the Dashboard.
 */
  ...
  return (
    <div className="topo-watermark bg-field-paper flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-10 text-center">
        <p className="text-[13px] font-semibold uppercase tracking-wide text-forest-600">Indonesia forestry-carbon partner discovery</p>
        <h1 className="mt-3 max-w-2xl font-display text-4xl font-bold text-stone-900 sm:text-5xl">
          Real forestry-carbon partners in Indonesia — found, scored, and evidence-checked.
        </h1>
        <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-stone-600">
          GluriBridge turns public registries, land-rights records, and news into one pipeline — every number here traces back to a
